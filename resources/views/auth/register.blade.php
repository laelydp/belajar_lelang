...
<head>
  ...
  <link rel="icon" type="image/png" href="{{ asset('assets/img/GO-LANG.png') }}">
  <title>
    Form Register
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                ...
                <div class="card-body">
                <form actipn="{{ route('register.store') }}" method="POST">
                  @csrf
                    ...
                    <div class="input-group input-group-outline mb-3">
                      ...
                      <input type="password" id="password" name="password" class="form-control form-control-xl @error('password') is-invalid @enderror" required autocomplete="new-password">
                    </div>
                          @error('password')
                            <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0">Registrasi</button>
                    </div>
                  </form>
                </div>
